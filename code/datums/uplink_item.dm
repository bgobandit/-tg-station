...
item/stealthy_weapons/foampistol
...
/datum/uplink_item/stealthy_weapons/dehy_carp
	...
	desc = "Looks like a plush toy carp, but just add water and it becomes a real-live space carp! Activate before use."
...
/datum/uplink_item/implants/uplink
	...
	The ability for an agent to open an uplink after their pos



sessions have been stripped from them makes this implant excellent for escaping confinement."
